...
## What It Does
HubSpot CRM is the foundational layer of the HubSpot platform. It stores and manages all customer data including contacts, companies, deals, tickets, and custom objects. It provides a unified view of customer interactions across marketing, sales, and service.
...
- Companies: 100,000 (Free), 500,000 (Starter), 1,000,000 (Pro), unlimited (Enterprise)
- Deals: No hard limit (performance degrades >5M)
- Custom properties per object: 1,000 (Free/Starter), 1,000 (Pro), 10,000 (Enterprise)
- Property options per dropdown: 1,000
- Pipelines: 10 (Starter), 50 (Pro), 100 (Enterprise) for deals
- Pipeline stages: 30 per pipeline for deals, 10 for tickets
